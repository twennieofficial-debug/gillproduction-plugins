...
3. Select a starting preset and play at least eight seconds with aligned main and beat. LEARN measures up to twenty seconds. STOP presents the preview; no gain changes until APPLY.
...
- Proposals use the median RMS of active windows. This is **not** an integrated LUFS meter, semantic vocal model or automatically finished mix. Silence, dropped telemetry, transport discontinuity, bypassed analysis and insufficient aligned context cannot produce an authorized learned set.
...
No Update 06 source or installed plugin is changed by this isolated group.
