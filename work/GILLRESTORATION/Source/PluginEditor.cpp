...
struct GillRestorationAudioProcessorEditor::Impl
{
    ...
    void paint (juce::Graphics& g)
    {
        ...
        g.setColour (juce::Colour (0xffffedcf).withAlpha (0.85f)); g.drawText (processor.getCaption(), captionBounds.translated (0,0.8f*s), juce::Justification::centred, false);
        g.setColour (ink); g.drawText (processor.getCaption(), captionBounds, juce::Justification::centred, false);
    }
};
