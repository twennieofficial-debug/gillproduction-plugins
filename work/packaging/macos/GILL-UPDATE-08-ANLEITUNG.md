# GILLPRODUCTION — Update 08: rechteckige Oberflächen

Das Bundle enthält weiterhin 39 VST3-Plugins. Zwölf Oberflächen füllen jetzt die komplette rechteckige Fensterfläche. Hochkant, Querformat und kompakte Ansichten bleiben je nach Funktion verschieden. Die übrigen 27 Plugins waren bereits rechteckig.

Aktualisiert auf 0.8.0: GILLVOX, GILLOPTA, GILLBUSS, GILLQUAD, GILLSTAGE, GILLRIDE, GILLCLEAN, GILLPOCKET, GILLALIGN, GILLFORM, GILLFINISH und GILLCONTROL. Die anderen Versionsnummern bleiben unverändert. Plugin-Kennungen, gespeicherte Parameter, Klangverarbeitung und Live-/Pro-Latenzen bleiben erhalten.

Die acht neuen Master-Artworks sind Designkonzepte und noch keine zusätzlichen ausführbaren Plugins. Dieses Update stellt die vorhandenen Oberflächen auf Rechtecke um.

Windows: FL Studio vor dem Update speichern und schließen. Der Installer ersetzt keine gerade verwendeten Dateien. In FL Studio unter Options > Manage plugins > Find installed plugins anschließend nach GILL suchen.

Mac: Universal VST3 für Apple Silicon und Intel. Wie vereinbart ohne Apple Developer ID / Notarisierung. Der Installer liegt in der DMG. Frühere VST3-Plugin-Kennungen werden beibehalten.

## Bedienung des vorhandenen Bundles
