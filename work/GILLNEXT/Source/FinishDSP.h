...
struct FinishParameters {
    float ceilingDb=-1,driveDb=0,comp=0,clip=0,width=100,bassMonoHz=80,lowDb=0,midDb=0,highDb=0;
...
public:
    ...
    void setParameters(const FinishParameters& p) noexcept{
        ...
        driveTarget_=std::clamp(detail::finite(p.driveDb),0.,18.);
...
private:
    ...
    double fs_=48000,smoothing_=0,compressorDetect_=0,compressorAttack_=0,compressorRelease_=0,limiterAttack_=0,limiterRelease_=0,truePeakDecay_=0;
